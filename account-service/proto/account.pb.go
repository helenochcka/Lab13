...
const file_proto_account_proto_rawDesc = "" +
	"\n" +
	"\x13proto/account.proto\x12\aaccount\"C\n" +
	"\aAccount\x12\x0e\n" +
	...
	"\x12CheckAccountExists\x12\".account.CheckAccountExistsRequest\x1a#.account.CheckAccountExistsResponseB!Z\x1faccount-service/proto;accountpbb\x06proto3"
