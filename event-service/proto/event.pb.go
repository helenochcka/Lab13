...
const file_proto_event_proto_rawDesc = "" +
	"\n" +
	"\x11proto/event.proto\x12\x05event\"w\n" +
	"\x05Event\x12\x0e\n" +
	...
	"\vReleaseSeat\x12\x19.event.ReleaseSeatRequest\x1a\x1a.event.ReleaseSeatResponseB\x1dZ\x1bevent-service/proto;eventpbb\x06proto3"
