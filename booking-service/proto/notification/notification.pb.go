...
func (x *BookingNotificationRequest) GetBookingId() string {
	if x != nil {
		return x.BookingId
	}
	return ""
...
const file_proto_notification_notification_proto_rawDesc = "" +
	...
	"\x1aBookingNotificationRequest\x12\x1d\n" +
	"\n" +
	"booking_id\x18\x01 \x01(\tR\tbookingId\"7\n" +
	"\x1bBookingNotificationResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess2\xf5\x01\n" +
	"\x13NotificationService\x12n\n" +
	"\x17SendBookingConfirmation\x12(.notification.BookingNotificationRequest\x1a).notification.BookingNotificationResponse\x12n\n" +
	"\x17SendBookingCancellation\x12(.notification.BookingNotificationRequest\x1a).notification.BookingNotificationResponseB3Z1booking-service/notification/proto;notificationpbb\x06proto3"
...
var file_proto_notification_notification_proto_goTypes = []any{
	(*BookingNotificationRequest)(nil),  // 0: notification.BookingNotificationRequest
	(*BookingNotificationResponse)(nil), // 1: notification.BookingNotificationResponse
}
var file_proto_notification_notification_proto_depIdxs = []int32{
	0, // 0: notification.NotificationService.SendBookingConfirmation:input_type -> notification.BookingNotificationRequest
	0, // 1: notification.NotificationService.SendBookingCancellation:input_type -> notification.BookingNotificationRequest
	1, // 2: notification.NotificationService.SendBookingConfirmation:output_type -> notification.BookingNotificationResponse
	1, // 3: notification.NotificationService.SendBookingCancellation:output_type -> notification.BookingNotificationResponse
