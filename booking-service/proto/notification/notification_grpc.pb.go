...
type NotificationServiceClient interface {
	SendBookingConfirmation(ctx context.Context, in *BookingNotificationRequest, opts ...grpc.CallOption) (*BookingNotificationResponse, error)
	SendBookingCancellation(ctx context.Context, in *BookingNotificationRequest, opts ...grpc.CallOption) (*BookingNotificationResponse, error)
}
...
func (c *notificationServiceClient) SendBookingConfirmation(ctx context.Context, in *BookingNotificationRequest, opts ...grpc.CallOption) (*BookingNotificationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BookingNotificationResponse)
...
func (c *notificationServiceClient) SendBookingCancellation(ctx context.Context, in *BookingNotificationRequest, opts ...grpc.CallOption) (*BookingNotificationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BookingNotificationResponse)
...
type NotificationServiceServer interface {
	SendBookingConfirmation(context.Context, *BookingNotificationRequest) (*BookingNotificationResponse, error)
	SendBookingCancellation(context.Context, *BookingNotificationRequest) (*BookingNotificationResponse, error)
...
func (UnimplementedNotificationServiceServer) SendBookingConfirmation(context.Context, *BookingNotificationRequest) (*BookingNotificationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendBookingConfirmation not implemented")
}
func (UnimplementedNotificationServiceServer) SendBookingCancellation(context.Context, *BookingNotificationRequest) (*BookingNotificationResponse, error) {
...
func _NotificationService_SendBookingConfirmation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BookingNotificationRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).SendBookingConfirmation(ctx, req.(*BookingNotificationRequest))
	}
...
func _NotificationService_SendBookingCancellation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).SendBookingCancellation(ctx, req.(*BookingNotificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
