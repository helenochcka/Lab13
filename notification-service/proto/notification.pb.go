...
const file_proto_notification_proto_rawDesc = "" +
	...
	"\x17SendBookingCancellation\x12(.notification.BookingNotificationRequest\x1a).notification.BookingNotificationResponseB+Z)notification-service/proto;notificationpbb\x06proto3"
